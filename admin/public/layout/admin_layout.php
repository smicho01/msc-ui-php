...
<head>
    ...
    <title>ADMIN - <?php echo $APPLICATION_NAME; ?></title>
...
<div class="container-fluid">
    <div class="row">
        ...
        <!-- Sidebar Nav -->
        <?php include_once("_admin_sidebar_nav.php"); ?>
        <!-- end Sidebar Nav -->
                ...
                <div class="col-12 view-wrap">
                    <div class="row">
                        <div class="col-12">
                            <!-- //USER_SIDEBAR -->
                            <?php
                            $viewVile = getViewFile($VIEW);
                            if(file_exists($viewVile)) {
                                include_once($viewVile);
                            } else {
                                include_once(ADMIN_VIEWS_DIR . DS . "no-view-file.php");
                            }
                            ?>
                        </div>
                    </div>
