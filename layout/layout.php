...
<head>
    ...
    <title th:text="#{app.name}" >Academi-Link</title>
...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="/" th:text="#{app.name}" >Academi-Link</a>
...
<script src="<?php echo JS_DIR; ?>/footer.js"></script>
