...
<div class="question-details-wrapper">
    <div class="row heading">
        ...
        <div class="col-12 question-summary-box">
            ...
            <span class="entry"><span class="light-txt">Your question:</span> <?php echo  QuestionService::isQuestionAuthorLoggedInUser($question)  ? '<i class="ikonka ikonka-winner fa-solid fa-circle-check"></i>'
