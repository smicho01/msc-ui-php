                    ...
                    <div class="col">
                        <div class="row answer-like-bar">
                            <div class="col-1"><span class="answer-like"><i
                                            class="ikonka pointer hoverable-green fa-solid fa-thumbs-up"></i></span>
                            </div>
                            ...
                            <div class="col-1"><span class="answer-unlike"><i
                                            class="ikonka pointer   hoverable-red fa-solid fa-thumbs-down"></i></span>
                            </div>
                            ...
                            <?php if (!$hasBestAnswerSelected && isUserLoggedIn() &&
                                ...
                                <div class="col-2"><span class="answer-like-count"><i
                                                ...
                                                data-bs-placement="top"
                                                title="Select as best answer and give tokens to author !"></i></span>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
